      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-6">
            <SectionHeading description="Food with warmth, depth, and a place at the center of the table. ComEat brings familiar Nigerian dishes into a modern, generous dining experience." eyebrow="Our point of view" light title="Nigerian food. No shortcuts." />
