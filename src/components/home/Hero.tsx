...
export function Hero() {
  return (
    <section className="relative min-h-[calc(100svh-5rem)] overflow-hidden border-b border-border">
      <Image alt="A shared table with Nigerian jollof rice, egusi, asun, puff-puff, and plantain" className="object-cover object-[62%_center]" fill priority sizes="100vw" src="/images/hero-feast.webp" />
