  ...
  return (
    ...
    >
      {items.map((item, index) => (
        <div className={`w-[82vw] max-w-[21rem] shrink-0 snap-start md:w-auto md:max-w-none md:shrink ${index === 5 ? "hidden md:block xl:hidden" : ""}`} key={item.id}>
