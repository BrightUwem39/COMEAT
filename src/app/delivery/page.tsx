...
export default async function DeliveryPage() {
  ...
  return (
    <main className="min-h-[calc(100svh-5rem)] bg-background py-7 sm:py-9 lg:py-11" id="main-content">
      <Container>
        <Link className="group inline-flex min-h-11 items-center gap-2 whitespace-nowrap text-[0.65rem] font-bold uppercase tracking-[0.14em] text-muted transition-colors hover:text-gold" href="/cart"><span aria-hidden="true" className="transition-transform group-hover:-translate-x-1">←</span> Back to order</Link>
