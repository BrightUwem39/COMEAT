...
export default async function CheckoutPage() {
  ...
  return (
    <main className="min-h-[calc(100svh-5rem)] overflow-x-clip bg-background py-7 sm:py-9 lg:py-11" id="main-content">
      <Container>
        <Link className="group inline-flex min-h-11 items-center gap-2 text-[0.65rem] font-bold uppercase tracking-[0.14em] text-muted transition-colors hover:text-gold" href="/delivery"><span aria-hidden="true" className="transition-transform group-hover:-translate-x-1">←</span> Back to delivery</Link>
        <header className="mt-5 border-b border-border pb-6 sm:flex sm:items-end sm:justify-between sm:gap-8">
          ...
          <p className="mt-3 max-w-sm text-sm leading-6 text-muted sm:mt-0 sm:text-right">Confirm the details below before continuing to secure payment.</p>
        </header>
